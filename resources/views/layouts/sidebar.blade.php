<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        @if($gecerliLogo&&$gecerliBilgi)
            <a class="navbar-brand m-0" target="_blank">
                <img src="{{ asset($fav_icon->fav_icon) }}" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <ul class="navbar-nav">
        ...
        <li
            ...
            <div class="collapse nav-submenu-submenu " id="site-settings">
                <ul class="nav flex-column ml-5">
                    <!-- Daha fazla boşluk -->
                    <li
                        class="nav-item  {{ Request::is('head-settings*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('head.index') }}">
                            <i class="fas fa-info-circle text-success"></i> <!-- İstenilen icon -->
                            <span class="nav-link-text ms-2">Genel İçerik Ayarları</span>
                        </a>
                    </li>
                    <li
                        class="nav-item  {{ Request::is('logo*') ? 'active' : '' }}">
                    ...
                    <!-- Sosyal Medya -->
                    <li
                        class="nav-item  {{ Request::is('sosyalmedya*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse nav-submenu" id="anasayfa-menu">
                            <ul class="nav flex-column ml-3">
                                <li
                                    class="nav-item  {{ Request::is('menualan*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('menualan.index') }}">
                    ...
                    <!-- İletişim Bilgileri -->
                    <li
                        class="nav-item  {{ Request::is('contact') ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item  {{ Request::is('iletisimform') ? 'active' : '' }}">
        ...
        <!-- Sayfalar -->
        <li
            class="nav-item  {{ Request::is('page') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            ...
            <div class="collapse nav-submenu-submenu" id="site-icerikleri">
                <ul class="nav flex-column ml-5">
                    <li
                        class="nav-item  {{ Request::is('homepage*') ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item  {{ Request::is('service*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('service.index') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="fa fa-list text-dark text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-2">Hizmetler</span>
                        </a>
                    </li>
                    <li
                        class="nav-item  {{ Request::is('marka*') ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item  {{ Request::is('news*') ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item  {{ Request::is('blog*') ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item  {{ Request::is('sss*') ? 'active' : '' }}">
        ...
        <!-- E-Bülten Abonelik -->
        <li
            class="nav-item  {{ Request::is('bulten') ? 'active' : '' }}">
