                        ...
                        <div class="card-body table-responsive">
                            <form action="{{ route('news.store') }}" method="POST"
                                ...
                                <div class="mb-3" id="gorselDiv" style="display: none;">
                                    ...
                                    @enderror
                                    <br>
                                    <label for="meta_title">Meta Başlık <p style="color: red; font-size: 16px; margin: 0;">Bu alan <b>Haber</b> içeriğinin gösterileceği sayfanın CEO optimizasyonu için gerekli bilgidir.</p></label>
                                    <input type="text"class="form-control" id="meta_title" name="meta_title"
                                        value="{{ old('meta_title') }}">
                                    <br>
                                    <label for="meta_description">Meta Açıklama <p style="color: red; font-size: 16px; margin: 0;">Bu alan <b>Haber</b> içeriğinin gösterileceği sayfanın CEO optimizasyonu için gerekli bilgidir.</p></label>
                                    <input type="text"class="form-control" id="meta_description" name="meta_description"
                                        value="{{ old('meta_description') }}">
                                    <br>
                                    <label for="meta_keywords">Meta Keywords <p style="color: red; font-size: 16px; margin: 0;">Bu alan <b>Haber</b> içeriğinin gösterileceği sayfanın CEO optimizasyonu için gerekli bilgidir.</p></label>
