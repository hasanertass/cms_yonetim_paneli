...
<head>
    <meta charset="utf-8">
    <title>{{$gecerliBilgi->SirketAdi}} - {{$service->title}}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="{{$service->meta_keywords}}" name="keywords">
    <meta content="{{$service->meta_description}}" name="description">
    <meta content="{{$service->meta_title}}" name="title">
        ...
        <div class="cs-blog-detail">
            <div class="cs-main-post">
                ...
                <div class="row">
                    ...
                    @else
                        <div class="ornek">
                            <img style="max-width: 500px;" src="{{ asset($service->large_image) }}" class="sola-kaydir">
                            {!! $service->long_description !!}
                        </div>
                    @endif
                </div>
