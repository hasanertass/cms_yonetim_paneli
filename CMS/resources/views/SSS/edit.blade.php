                ...
                <div class="col-md-24">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Soru Düzenleme Sayfası</h5>
                        </div>
                        @if($errors->any())
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="sayfa_id" name="sayfa_id" required>
                                        ...
                                        @foreach($sayfalar as $sayfa)
                                            <option value="{{ $sayfa->sayfa_id }}" {{ $sayfa->sayfa_id == $sss->sayfa_id ? 'selected' : '' }}>{{ $sayfa->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="Soru" name="Soru" rows="3" 
                                        required>{{ old('Soru',$sss->Soru) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="cevap" class="form-label">Cevap</label>
                                    <textarea class="form-control" id="Cevap" name="Cevap" rows="3"
                                        required>{{ old('Cevap',$sss->Cevap) }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="sira" class="form-label">Sıra</label>
                                    <input type="number" class="form-control" id="Sira" name="Sira"
                                        value="{{ old('Sira',$sss->Sira) }}" required>
                                </div>
