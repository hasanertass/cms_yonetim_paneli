                            ...
                            <form action="{{ route('service.update',['service' => $service->id]) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-group">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center gap-6">
                                                <input type="text" class="form-control" id="icon" name="icon"  value="{{ old('icon',$service->icon_class->icon ) }}"
                                                    onkeyup="updateIcon(this.value)">
                                                <i id="selected-icon" class=""
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="description"
                                        value="{{ old('description',$service->description) }}" name="description" required>
                                </div>
                                <div class="d-grid">
