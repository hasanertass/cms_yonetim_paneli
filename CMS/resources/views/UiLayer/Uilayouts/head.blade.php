...
@if($gecerliBilgi&&$ıcons)
    <div class="container-fluid  text-light p-0" style="background-color: #114ca2;">
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    <small class="fa fa-map-marker-alt text-primary me-2"></small>
                    <a href="https://www.google.com/maps/search/{{ urlencode($gecerliBilgi->Adres) }}" style="color: #f5f5f5;" target="_blank">{{ $gecerliBilgi->Adres }}</a>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
                    <small class="far fa-clock text-primary me-2"></small>
                    <small>{{ $gecerliBilgi->work }}</small>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div class="h-100 d-inline-flex align-items-center me-4">
                    <small class="fa fa-phone-alt text-primary me-2"></small>
                    <a href="tel:{{ $gecerliBilgi->Telefon }}">{{ $gecerliBilgi->Telefon }}</a>
                </div>
            </div>
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
    @if($gecerliBilgi&&$gecerliLogo&&$anaSayfa)
        <a href="/" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <img style="width: 100px; height: 100px;" src="{{ asset($gecerliLogo->FilePath) }}" class="navbar-brand-img h-100" alt="main_logo">
