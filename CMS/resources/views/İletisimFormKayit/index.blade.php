                ...
                <div class="col-md-24">
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div>
                                <a href="{{ route('excele-aktar', ['veri' => $formName->FormId]) }}" class="btn btn-outline-danger">Excel'e Aktar</a>
                                <a href="{{ route('pdf-aktar', ['veri' => $formName->FormId]) }}" class="btn btn-outline-primary">PDF'e Aktar</a>
