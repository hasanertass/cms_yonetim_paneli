...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'Telefon2'=>'Telefon 2',
        'Telefon'=>'Telefon',
        'KullanımDurumu'=>'Kullanım Durumu',
        'FormName'=>'Form Adı',
        'AlanName'=>'Alan Adı',
        'AlanType'=>'Alan Tipi',
        'Name'=>'Ad',
        ...
        'FilePath'=>'Dosya',
        'MarkaName'=>'Marka Adı',
        'MarkaLogo'=>'Marka Logo',
        'MenuAdı'=>'Menü Adı',
        'MenuSırası'=>'Menü Sırası',
        'MenuLink'=>'Menü Linki',
        'ItemAdı'=>'Alt Menü',
        'ItemLink'=>'Alt Meni Linki',
        'ItemSırası'=>'Alt Menü Sırası',
        'Icon'=>'İcon',
        'Link'=>'İcon Linki',
        'Baslik'=>'Başlık',
        'Sira'=>'Sıra',
        ...
        'password'=>'Şifre',
        'link_type'=>'Link Tipi',
        'link_open'=>'Bağlantı Açılış Yöntemi',
        'îmage'=>'Görsel',
        'görsel2'=>'Görsel',
        'görsel'=>'Görsel',
        'sayfa_id'=>'Sayfa',
        'FormName'=>'Form Adı',
        'PleaceHolder'=>'Pleace Holder',
        'AlanName'=>'Alan Adı',
        'AlanTye'=>'Alan Tipi',
        'AlanSırası'=>'Alan Sırası',
        'description'=>'Açıklama',
        'contact_form'=>'İletişim Formu',
        'alan_name'=>'Alan Adı',
        'aciklama'=>'Açıklama',
        'kisa_aciklama'=>'Açıklama',
        'tarih'=>'Tarih',
        'link'=>'Link',
        'url'=>'URL',
