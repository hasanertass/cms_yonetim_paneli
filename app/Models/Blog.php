...
class Blog extends Model
{
    ...
    protected $fillable=['id','title','short_description','long_description','date','small_image','large_image','link','status','home_page_status','meta_title','meta_description','meta_keywords'];
