...
class iletisimFormAlanController extends Controller
{
    ...
    {   
        ...
        $form_name=IletisimForm::where('FormId',$id)->first();
        return view('iletisimFormAlan.index', compact('iletisimFormAlanlar','hasDuplicateAlanSirası','iletisimForm','form_name' ));
    }
