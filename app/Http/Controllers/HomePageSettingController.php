    ...
    public function store(Request $request)
    {
        ...
        try {
            if ($request->hasFile('image')) {
                ...
                $fileNameWithExtension = $title.'.'.$extension; // Logo adını ve uzantısını birleştir
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $eskiGörselYolu = storage_path('app/public/anasayfa/' . $title);
                ...
                // Yeni görseli kaydet  
                $görselAdi = $title . 'Görsel.' . $görsel->getClientOriginalExtension();
